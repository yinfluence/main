...
const WEBSITE_LOG_ENTRIES = [
  {
    ...
    items: [
      ...
      'B 站 AI 字幕转写稿 2633 行逐句读完。回字幕核对了四十多项数字和专名，全部能在转写稿里找到。外部核对了北京无人机新规、中信大厦撞机、杭州 7·26 酒局事件和 3600 亿注资，写进了边界。机器人公司现价、当场报的利率大数没有核实，按当场说法收。',
      'audit-lives 机器检查全过，ai-flavor-check 只剩名单类列举。'
    ]
  },
  {
    date: '2026-09-15',
