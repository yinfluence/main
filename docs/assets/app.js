...
const WEBSITE_LOG_ENTRIES = [
  {
    date: '2026-09-26',
    title: 'EP217 上线，交出经营权也把债务一起交了出去',
    items: [
      'EP217 是 9 月 25 日 19 点发的，B 站和 YouTube 都是普通视频。节目用华删派气宗剑宗分家影射华为和赛力斯，正文按化名口径换成华为、赛力斯和小米，边界里写明化名对应是公众解读、不是事实指控。9 月 15 日问界改由赛力斯主导按公开报道写，华为主动避险是节目对动机的推断，单车只赚 600 元按零跑半年报折算的出处写进了边界。五条核心观点分别落在利润分配、加盟体系、品牌溢价、风险隔离、合作结构。',
      '新建概念分润反噬，新建关键词赛力斯、问界、赵一鸣零食、加盟模式、品牌溢价五条，合作调整和缺斤短两风波挂了外部来源。华为、小米、新能源汽车、供奉、隔离墙、依附型车企、价格战、成本转嫁这些已有关键词回填了这一期。前置抽成、高价叙事、责任隔离墙、生产端风险外包、依附型企业五个概念，风险转移链条、价值捕获两个模型，新能源崩塌与退出风险、政企嵌入与企业存续、品牌符号与价值感知三个主题都回填了本期。',
      '相关节目串上 EP153 华山派技术叙事、EP170 福威镖局凛冬已至、EP176 六月车企销量、EP187 赛力斯巨亏、EP210 China GT 起火、EP216 比亚迪利润奖，延展话题按华为和赛力斯、电车利润、外包和加盟三条线写。思考与分析三段从收益和风险放在谁手里看治理的根子、从溢价看一个社会的信任、从谁先离场看人性。'
    ]
  },
  {
    date: '2026-09-23',
    title: 'EP216 上线，拖欠货款是大企业最便宜的借钱办法',
    items: [
      'EP216 是 9 月 23 日 19 点发的，B 站和 YouTube 都是普通视频。节目用福威镖局年终奖不发影射比亚迪利润奖风波，正文按化名口径换成比亚迪，边界里写明化名对应是公众解读、不是事实指控。利润奖是否取消按界面新闻的报道当传闻处理，海外占比过半按收入口径理解，工资二十二号发、交通不报这几条节目说法没有公开资料能核，都写进了边界。五条核心观点分别落在薪酬设计、供应链金融、债务形态、出海布局、工资与消费。',
      '新建概念工资消费循环，新建关键词利润奖、供应链金融、比亚迪巴西工厂劳工案、福特五美元日薪四条，都挂了外部来源。比亚迪、成本转嫁、地方债、车企出海、护照、消费占比、新能源汽车、福威镖局这些已有关键词回填了这一期，比亚迪和福威镖局各补了一条问题线。成本外移、隐形债务、虚假销售三个概念，风险转移链条、路径依赖两个模型，新能源金融化与虚假销量、新能源崩塌与退出风险两个主题，以及王传福的人物页都回填了本期。',
      '相关节目串上 EP015 地方债与电车、EP080 车圈福威镖局、EP093 零首付购车、EP170 福威镖局凛冬已至、EP176 六月车企销量、EP211 荷兰拒保中国电车，延展话题按比亚迪、电车出海、电车的钱三条线写。思考与分析三段从危机里谁先让利看一个国家的前途、从欠账看一个社会讲不讲信用、从对内对外看人心。'
    ]
  },
  {
    date: '2026-09-21',
    title: 'EP215 上线，掐尖掐出来的成绩算在了管理头上',
    items: [
      'EP215 是 9 月 21 日 19 点发的，B 站是会员视频，YouTube 是普通视频。从衡水中学系清北人数从两百多人掉到四十多人讲起，真正变的是招生半径，河北 2021 年起逐年压缩跨区招生、2024 年起公办普高只能属地招生，把全省尖子生集中到一所学校的做法走不通了。后半段讲家长为什么还愿意送，买的是把管教交出去之后的免责。五条核心观点分别落在生源结构、组织管理、家庭责任、校内分层、人格养成。',
      '新建概念掐尖和教育外包，新建关键词衡水中学、掐尖、属地招生、军事化管理、教育外包、应试教育六条，招生政策和录取人数挂了外部来源。清北这个已有关键词回填了这一期并补了一条问题线。考试中心化规训、条件化亲情循环两个概念，筛选机器模型、个体化三阶段模型两个模型，考试中心教育与人成形、成长与亲情边界两个主题都回填了本期。',
      '相关节目串上 EP014 排便自由、EP058 教育与AI错位、EP063 精神三弑、EP118 北大神课被砍、EP150 学区房与学生荒、EP157 教育当文化洗钱，延展话题按应试教育、精神三弑、教育花的钱三条线写。思考与分析三段从考试看一个社会怎么维持秩序、从排名看一个社会的力气花在哪、从管教看人怎么长成。'
    ]
  },
  {
    date: '2026-09-20',
    title: 'LIVE043 上线，征兵名单上从来没有首都的人',
    items: [
      'LIVE043 是 9 月 19 日 21 点场，120 分钟，充电专属。主线讲俄乌打了四年多、死了几十万到一百五十万人，国内为什么没闹起来。翻历史，拿破仑、克里米亚、苏芬和二战四场仗的战损比都在四五比一，赢的方式一直是熬。底子是农奴制，一个农奴兵值的就是他二十年在地里的产出，军官私下管士兵叫灰色的牲口。今天换成囚犯和穷地方的人，征兵名单上没有首都，家属拿抚恤金和荣誉，妻子会自己把人送去。出生率降下来之后，这套算法开始不灵。后半场讲赚钱的三拨人，跟着复制的那一拨这轮赚不到，要从销售端倒回生产端。开篇过了一遍中美会面前的静默期，中间看了一份选出加拿大领导国际事务的民调。',
      '分四个大话题十节，另收四条直播间问答，讲内卷里那差的百分之五六七、个人IP是不是当网红、算命跟创业的关系、富贵险中求该怎么看。二十二个标签在关键词库里全部有词条，没有新建词条。',
      'B 站 AI 字幕转写稿 3131 行逐句读完。回字幕逐条核对了 68 项数字、人名、机构名和直接说法，全部能在转写稿里搜到。一万个起订要先垫多少钱，当场先说五十万又改口十万，正文没有取数，写进了边界。二战战损比当场报了几个数又改口，取不到四比一。乌克兰暗杀对象在字幕里是一串听不出的音，只写亲俄人员。北方那座城市当场没点名，按直播里自述在北京住过又离开这条线索写成北京。历史数字、民调数字和美国加息那一条都是当场凭记忆报的，按量级和观点收。',
      'audit-lives 八道机器检查全过，ai-flavor-check 只剩固定口径和名单类列举，繁体扫描干净。'
    ]
  },
  {
    date: '2026-09-19',
    title: 'EP214 上线，品牌会跟着它的客人一起变老',
    items: [
      'EP214 是 9 月 19 日 19 点发的，B 站和 YouTube 都是普通视频。从耐克被移出标普100、lululemon 下调全年营收预期讲起，两家下滑背后是两层原因，一是品牌绑定的那代人老了，二是全球中产在收缩，中高端运动服饰是最先被砍的可选消费。五条核心观点分别落在代际更替、身份符号、可选消费、市场格局、品牌经营。',
      '新建概念身份溢价，新建关键词耐克、lululemon、标普100、可选消费，指数调整和财报数字挂了外部来源。中产阶级、K型分化两个关键词，路径依赖模型，中产下坠与分层社会、品牌符号与价值感知、消费客群重写三个主题回填了这一期。',
      '相关节目串上 EP003 始祖鸟、EP052 中产斩杀线、EP119 白酒、EP156 新旧中产、EP166 山姆、EP200 楼市新政，延展话题按中产消费、中产收缩、品牌换代三条线写。思考与分析三段从中产看社会的底盘、从身份符号看人性里分高低的那股劲、从成功看人最难放下的东西。'
    ]
  },
  {
    date: '2026-09-19',
  ...
  },
  {
    ...
    items: [
      'EP213 是 9 月 17 日 19 点发的，B 站和 YouTube 都是普通视频。从八家中央金融企业合计 3600 亿元注资讲起，这些机构账面都不缺钱，缺的东西在账面下面。卖地卖不动以后，地方平台自拿土地托住地价，抵押贷款又变回出让金，风险经同业、理财和债券传到大行和险企。注资只给下游补本钱，828 地产新政收紧的是这套拿地抵押的玩法。五条核心观点分别落在资产质量、风险传导、危机处置、政策信号、代际分配。',
      '新建概念有价无市资产。新建关键词中央金融企业注资、828地产新政、资本充足率三条，各自写满该 kind 的字段。828地产新政顺带回填 EP207，四十年房贷那一条出自这轮新政。本期七个标签在关键词库里全部有词条。',
      '回填资产负债表托底、价格发现延迟、隐形债务三个概念，资产负债表维持、风险转移链条两个模型，地方财政与隐性债务、价格托底与账面维稳、房地产去杠杆与风险出清三个主题，城投、地方债、房地产、土地财政四条关键词各加了一组节目关联。LIVE042 直播间问过为什么注资，相关节目里接上了本期。',
      '外部核对了八家机构名单和金额、3000 亿特别国债、烟草系统 600 亿，以及 828 新政的五部门和主要条文，写进了边界。字幕里烟草出资说的是六七百亿，按公告取 600 亿。城投拿地占比六成、八成是节目的量级，跟公开口径对不上，按方向收。新政条文没有点名城投，瞄准地方平台是节目的解读。',
      'check-episode-style 与 audit-episodes 本期通过，ai-flavor-check 只剩机构名单类列举，繁体扫描干净。npm run test:ui 停在关键词首页分组那条断言，属于既有问题。'
    ]
  },
  {
    date: '2026-09-17',
    title: 'LIVE042 上线，没人扫的缝一出事，就被管过了头',
    items: [
      'LIVE042 是 9 月 16 日 21 点场，113 分钟，充电专属。主线从北方大城市禁止持有无人机讲起，先禁卖，再禁飞，现在家里放一架都不行。两个国有单位中间的雪原来靠煎饼摊扫，摊子没了，缝里一出事，各部门都来加码。直播拿武林作对照，兵器唐朝开始禁，明清管得最严，比武只剩表演，演久了成了规矩。后半场讲商K被一刀切、公共道德标准越抬越高，讲低利率和汇率升值两条不能动、代价落到工资上，也讲巨头往下掉的时候普通人的机会。分五个大话题十二节，另收四条直播间问答，讲银行保险为什么注资、不借钱行不行、人民币会不会大贬值、七年内会不会打起来。',
      '新建关键词义和团、商K、渡边太太、周文强四条，各自写满该 kind 的字段。本期十七个标签在关键词库里全部有词条。',
      'B 站 AI 字幕转写稿 2633 行逐句读完。回字幕逐条核对了 176 项数字、人名、机构名和说法，全部能在转写稿里搜到。外部核对了北京无人机新规、中信大厦撞机、杭州 7·26 酒局事件和 3600 亿注资，写进了边界。机器人公司现价、当场报的利率大数没有核实，按当场说法收。',
      'audit-lives 机器检查全过，ai-flavor-check 只剩名单类列举。npm run test:ui 停在关键词首页分组那条断言，改动前的版本同样停在这里，属于既有问题。'
    ]
  },
  {
    date: '2026-09-15',
    title: 'LIVE041 上线，秘鲁一入盟，钱凯港就排进了下一轮日程',
    items: [
      'LIVE041 是 9 月 12 日 21 点场，95 分钟，充电专属。卢比奥 9 月 10 日到访利马，新任总统藤森庆子随即宣布加入美洲之盾，直播以秘鲁为主线，把这件事读成秘鲁站进了美国阵营。钱凯港水深 17.8 米，上海过去的航程从 35 天缩到 23 天，要运的主要是铜和伴生矿。港口一旦被全面监管，每箱货装什么、装多少都要记数，按低价运走矿的路就断了。后半场讲老藤森为连任改宪法之后五次被反噬，讲电车的低价出在矿山和工人身上，讲华工和日裔在秘鲁的不同处境，最后讲南美当年底子好，钱却没分到干活的人手里。分五个大话题十二节，另收四条直播间问答，讲钱凯港会不会打水漂、古巴是不是下一个、老藤森图的是什么、普通人该支持左翼还是右翼。',
      '新建关键词秘鲁、钱凯港、藤森庆子、藤森、卢比奥、美洲之盾六条，各自写满该 kind 的字段。卢比奥回填了 LIVE004 和 LIVE010，LIVE010 一直显示不出来的卢比奥标签也接上了。本期十三个标签在关键词库里全部有词条。',
      'B 站这场没有生成 AI 字幕轨，改用本地 whisper 转写音频，音频 95 分 10 秒，转写覆盖到 5708 秒。回字幕核对了 49 项数字和专名，全部能在转写稿里找到。外部核对查出六处跟当场说法对不上，都写进了边界。钱凯港 1 月那次法院裁定其实是让监管机构退后，1% 监管费没有查到。秘鲁 2025 年铜产量排第三，不是第二。两洋铁路还在可行性研究阶段。庆子决选赢了约五万票。道德无能力条款 1839 年的宪法里就有，2016 年以来上任的总统是八位。巴西人均 GDP 约 1.07 万美元。开头聊的喷气式无人机只是插话，没有收。',
      'audit-lives 机器检查全过，ai-flavor-check 清零。'
    ]
  },
  {
    date: '2026-09-15',
    title: 'EP212 上线，按公式算出的涨幅经得起查',
    items: [
      'EP212 讲新加坡这轮政治职务加薪。9 月 8 日政府接受独立委员会的建议，初级部长参考年薪从 110 万新元调到 180 万，总理年薪按两倍算到 360 万，10 月 15 日起生效，是 2012 年减薪之后十五年来头一回调整。节目认可高薪养廉，拆了三层。基准取收入最高一千名公民的年收入中位数再打六折，打折是为了跟私企抢人，也承认公共服务要少拿一截。黄循财捐出自己加薪的部分，节目借它说明薪水认可的是岗位价值。判断落在适用边界上，这套办法只在城市国家跑得通。五条核心观点落在适用边界、薪酬公式、人才竞争、岗位定价和道德要求上。思考与分析写了三段，官员的薪水、一个位置开出的价钱、要不要谈钱。',
      '新建概念岗位定价，道德资本、梯队接班制两条补上本期，模型回填制度适配、规则锚定型小国生存和委托代理问题。主题回填新加坡与小国生存术、人的价值与国家信用。新建关键词高薪养廉、新加坡部长薪金检讨、城市国家三条，城市国家顺带回填了 EP140 的组屋。新加坡、香港、道德绑架三条关键词和黄循财的人物页补上本期，各加了一组节目关联。相关节目串到 EP181、EP096、EP190 的新加坡抢人，EP122、EP140 的新加坡规矩，EP083、EP164 的学新加坡。',
      'B 站到上线时还没发这一期，YouTube 9 月 15 日已发，videoLinks 先挂 YouTube，B 站留暂未上架的占位，等自动回补。两边都没有字幕轨，改用本地 whisper 转写 YouTube 音频，音频 15 分 1 秒，转写覆盖到最后一句。校对了颖响力、涨薪、高薪养廉、MR4、中位数、黄循财、抄作业这些转写错字。薪金数字、生效日期、在任部长先调 9%、总理的捐款承诺、2012 年减薪、2017 年未采纳和 2023 年推迟、工人党在辩论里的立场、新加坡和香港的清廉指数排名，另查了新加坡公共服务署、总理公署和外媒报道核对。节目说十几年前的薪水比现在还高，拿来比的是调整前的 220 万，这一点写进了边界。'
    ]
  },
  {
    date: '2026-09-12',
    title: 'EP211 上线，保险公司不接算不出赔多少的车',
    items: [
      'EP211 从荷兰保险公司 Univé 收紧车险讲起。2026 年 8 月中旬它对九个品牌停保，对五个品牌只保第三者责任险，名单主体是中国车企。节目拆的是售后那一半账，车卖得便宜，配件靠海运、维修网点少，修一次拖几个月，赔付算不出底，保险公司只能不接。后半段借诺兰电影《奥德赛》里的木马计，讲靠钻空子打破的规则，代价会延后兑现。五条核心观点落在风险定价、售后体系、规则博弈、竞争方式和信任成本上。思考与分析写了三段，风险能不能算清、代价什么时候结账、人对往后的日子有没有指望。',
      '新建概念不可定价风险，钻规则反噬、低价竞争陷阱、成本外移三条补上本期，模型回填制度适配和风险转移链条。主题回填新能源设计抄近路与技术捷径、低价竞争与精准打击、法治边界与社会信任。新建关键词 Univé、荷兰、维修权三条，新能源汽车、车企出海、价格战、保险公司、奥德修斯、China GT 六条补本期并各加了一组节目关联，奥德修斯顺带补了做事方式。九个标签在关键词库里全部命中。相关节目串到 EP176、EP187、EP080 的电车出海，EP182、EP178、EP210 的钻规则，EP062、EP208、EP191 的欧洲标准，EP153 的弯道超车。',
      'B 站接口 is_upower_exclusive 为假，是普通视频，YouTube 同日已发，两条链接都挂上了。字幕用的是 B 站 AI 字幕，拒跑、献宝、轨迹、木马纪这类转写错字分别校成拒保、限保、诡计、木马计。拒保名单另查了外部报道，九个停保品牌里有韩国 KGM 和越南 VinFast，只保第三者责任险的五个里有美国 Lucid，比亚迪不在名单上，这几点写进了边界。奥德修斯漂流的起因、欧洲电池回收要求、更多保险公司会跟进，按节目的读法和预测收，不当作已核实的事实。'
    ]
  },
  {
    date: '2026-09-10',
    title: 'EP210 上线，一天六十块雇不来冲进火里的人',
    items: [
      'EP210 从 China GT 上海站的起火事故讲起。9 月 5 日 GT3 组第七圈，两辆赛车冲出赛道撞上 91 号法拉利，英国车手米尔罗伊被困在起火的座舱里，把他拖出来的是停车赶来的荷兰车手哈托格。节目拆了三层，赛事的钱花在明星、冠名和流量上，救援据说层层外包到一线日薪六十块，凑合的做法放到国际同行面前会被判不合格。五条核心观点落在体育商业、用工结构、行业竞争、合规标准和国际接轨上。思考与分析写了三段，底线怎么一点点失守、一件事转过几道手、凡事都能谈价钱。结尾点到华山派、丐帮、福威镖局三个化名，边界里写明化名影射、对应关系是公众解读、非事实指控。',
      '新建概念层层转包，合规及格线、血写的规则、成本外移、低价竞争陷阱、守规者出局五条补上本期，模型回填委托代理问题和风险转移链条。主题回填低价竞争与精准打击、人的价值与国家信用、新能源安全边界与消费者测试。新建关键词 China GT、体育精神、外包三条，潜规则、内卷陷阱、逆淘汰、华山派、丐帮 · 帮主、福威镖局六条补本期并各加了一组节目关联。九个标签在关键词库里全部命中。相关节目串到 EP204 和 EP205 的内卷、EP151 的逆淘汰、EP186 和 EP152 的安全规范、EP208 和 EP199 的国际标准、EP187 和 EP195 的化名品牌。',
      'B 站这期刚发布时还没生成 AI 字幕轨，YouTube 也没有字幕，改用本地 whisper 转写 YouTube 音频。音频 21 分 21 秒，转写覆盖到最后一句。校对了颖响力、组别、挥旗、浓烟、技术岗、日结、潜规则、福威镖局这些转写错字。事故经过、两位车手的国籍和车号、组委会 9 月 6 日的声明另查外部资料核对过。专业救援多久到场各方说法不一，本页不采任何一个数字，日薪六十块按节目转述收。B 站接口 is_upower_exclusive 为假，是普通视频，YouTube 同日已发，两条链接都挂上了。'
    ]
  },
  {
    date: '2026-09-09',
    title: 'LIVE040 上线，启动的口子放大之后，条款才谈得上',
    items: [
      'LIVE040 是 9 月 9 日 21 点场，101 分钟。主线是十月一号起实行的那部法的新旧差别，直播全程没有点名，本页跟着这个口径。四处改动：启动前提在主权、统一、领土完整、安全之外添了发展利益遭到威胁，海外港口和油田里的份额都能算；适用范围从跟军事沾边的一小块扩到经济和社会的每一部分；实施程序把决议挪到了动手之后；可动员人员从民兵预备役扩到后备兵员，男的十八到六十，女的十八到五十五，另有专业特殊技能不受年龄限制而标准没写。措辞上征用改成征收和征用，征收在前、用完不还，豁免只剩个人家庭生活必需品，最小管理单位从县级政府落到各级政府。后半场用诸葛亮治蜀讲备战不等于开打，再把古代法家跟现代法治拆成南辕北辙的两件事。分五个大话题十二节，另收五条直播间问答，讲黄金、S3、数据、价值投资和这一代年轻人。',
      '新建关键词战备、法家、赵括、征收、后备兵员、网格员六条，全部写满该 kind 的字段。战备回填 EP189、LIVE021、LIVE026，法家回填 EP152，赵括回填 EP014、EP078，网格员回填 EP152、LIVE005、LIVE011、LIVE022，征收回填 EP184。本期十六个标签在关键词库里全部命中，页面上都显示得出来，顺带把 LIVE021、LIVE026 的战备标签也接上了。',
      '回字幕核对抽了 24 项：四个刚性条件的原文、十月一号实行、正常半年到一年、男十八到六十与女十八到五十五、快五十岁那句自述、国标一百米与非国标八十米、一个县一个亿写成八十多个亿、权利五条与第六条月球土地、说对一两成、九月初播放量断崖、书院几百上千人，全部与字幕对得上。三处按核对结果改掉：China GT 那段情绪的起因是又想起 B 公司，不是赞助商名单本身，原稿写反了；电线加的量词一卷字幕里没有，删掉；S3 与 S2 是直播里的讳称，原先解码成三战二战，按 sop/05a 化名口径改回原写法。另外比对了 LIVE039 的专属数字（十七个油田、六百五十亿桶、两千亿美元、每桶十二美元），确认没有串到这一场来。',
      'audit-lives 八道机器检查全过；ai-flavor-check 剩八处，分别是法条四个刚性条件的列举、民兵预备役到后备兵员这组新旧替换、养猪那段的数据链条列举，以及保的不是蜀人是汉室余脉、权利不是天生的是分配下来的、不是小时候苦是中间苦这三句主播原话里的核心判断，按 sop/08 的例外条款保留。'
    ]
  },
  {
    date: '2026-09-08',
    title: 'EP209 上线，挑市场先挑验不了真假的人',
    items: [
      'EP209 拆 52 名新加坡公民在广西涉嫌参与传销被捕这件事，这是新加坡人在海外单次被扣最多的一次。指向的是 1040 阳光工程，交 6.98 万元买入伙资格，拉三个人再往下复制，凑够 29 人当上老总，拿满 1040 万出局。它一件商品都不卖，可信度全靠把北部湾开发、西部大开发和南宁新区的高楼认领成自己的成果。查处在里面被解释成宏观调控，说是淘汰胆小的，最有力的反面证据反而成了正面证据。跨境挑中新马华人社群，靠的是话术全中文、亲戚连着亲戚、海外华人又验不了大陆政策的真假。五条核心观点落在骗局设计、政策外壳、免疫机制、熟人网络和跨境选择上。思考与分析写了三段，骗局借谁的名义、核实一件事要花多大力气、被骗之后接着做了什么。',
      '新建概念政策外壳、打击即证明、受害者转招募人三条，预期贩卖和法律灰区补上本期，新建模型熟人网络收割模型，叙事杠杆和惩戒失效循环模型回填本期。主题回填法治边界与社会信任、投资叙事与散户陷阱、新加坡与小国生存术。新建关键词传销、1040阳光工程、北海、领事保护四条，广西、新加坡、马来西亚、信息不对称四条补本期并各加了一组节目关联。八个标签在关键词库里全部命中。',
      '事实另查外部资料核对过。新加坡外交部与警察部队 9 月 4 日的联合声明写明 52 人被捕、领事官员探视全部 52 人、政府不介入他国司法程序。官方没有公布涉案的具体项目名称，指向 1040 阳光工程是节目按广西传销常见形态作的判断，边界里写清了照此收、不作官方认定。7 月中旬被拘留一说来自节目引述的亚洲新闻台，联合声明里没有拘留日期。组织领导传销要够三十人和三个层级才追刑责，按最高检的口径核过。字幕把入伙费的新元换算说成 13 万，按现在的汇率是一万三千新元上下，正文只用人民币数字。相关节目串到 EP163 的信息差与事后追责、EP159 的官方信用前置、EP149 的广西通道建设、EP199 和 EP200 的判断力与算计。B 站是充电专属，接口里 is_upower_exclusive 为真，episode 和覆盖表都标了会员，YouTube 同日已发，两条链接都挂上了。'
    ]
  },
  {
    date: '2026-09-06',
    title: 'EP208 上线，打不动这家公司，就去打它的买家',
    items: [
      'EP208 拆星宇股份批量劝退应届生这件事。440 名 2026 届毕业生签的是研发技术岗，入职一个月后分批约谈，主动离职拿半个月工资或者调去流水线拿普工薪资二选一，107 人签了字。这批人没走仲裁，把 offer、录音、考勤整理成上百页材料翻成英文，同时递给奔驰大众的合规部门、港交所和常州人社局，十几天里换来人社局通报、公司致歉、人力总监停职和加码的补偿。判断落在维权成本与违法成本的落差上，国内耗的是个人的时间，企业赔的是两个月工资，这笔账一直算得过来。思考与分析写了三段，受了委屈的人往哪里去、违反一条规则要付多少、这批人先做了什么。',
      '新建概念外部规则杠杆和灰色裁员两条，合规成本落差、成本外移两条补上本期，模型回填规则边界型维权模型和风险转移链条，主题回填法治边界与社会信任、年轻人梦想与安全路径、人的价值与国家信用。新建关键词星宇股份、应届生、港交所、供应链尽职调查、劳动仲裁五条，裁员、工会、欧盟三条补本期并各加了一组节目关联。八个标签在关键词库里全部命中。',
      '事实另查外部资料核对过。常州人社局 8 月 25 日通报的 440 人、107 人和未发现违规享受补贴，8 月 27 日致歉信与人力总监停职，7 月 29 日二次递表、8 月 14 日证监会备案，奔驰立案、大众回函调查、港交所把投诉作个案核查，德国供应链尽职调查法 2023 年生效和欧盟同类指令 2024 年生效，来源都写进了词条。节目按一票否决讲上市审核，公开报道口径要弱一些，边界里写清了按后者收。相关节目串到 EP186 的工会谈判权、EP039 的分配位置、EP145 的就业难、EP158 的裁员竞赛、EP024 的劳资爆裂。B 站是普通视频，YouTube 当天还没发，链接先留一条。'
    ]
  },
  {
    date: '2026-09-05',
    title: 'LIVE039 上线，十七个油田签给美国，那条线从去年十二月就在走',
    items: [
      'LIVE039 是 9 月 5 日 21 点场，118 分钟。主线是美委那份石油协议：六百五十亿桶储备、十七个油田、约占全国三成，短期二十年，据说长达一百年。一千亿美元投资全由石油企业出，政府一分不掏，产权留在委内瑞拉，收入直接进国库，二十年两千亿美元。九月三号霍尔木兹海峡的运力已经从两千万桶恢复到一千八百万桶，少掉的正是每天一千万桶的灰色贸易，涨到三百美元的说法就此落空。',
      '分五个大话题十二节：十七个油田换两千亿美元的账、以前这些油是怎么流出去的、欧洲抱成一块北边就坐不住了、爱钱这件事也能当信仰输出去、奥德修斯的十年赔进一个时代。旧账那一组收了给古巴倒贴每桶十二美元、给东大二十美元以上优惠、给大毛直接是油田代理权三条线。四条直播间问答收了委内瑞拉欠的钱还认不认、做空德国是不是版本答案、权力怎么关进笼子里、朗朗那边还能撑多久。',
      '转写稿 28407 字逐句读完，数字、人名、机构名和直接引述逐条回字幕核对，抽了 22 项，海峡运力两个数、油田数与储量、两笔美元金额、每桶倒贴 12 美元、99 年抵押和两个日期全部对得上，没有把上一场的数字挪过来。新建马杜罗词条，写满人物字段并回填 EP098、EP161、EP168。本期 14 个标签在关键词库里全部命中，页面上都显示得出来。'
    ]
  },
  {
    date: '2026-09-03',
