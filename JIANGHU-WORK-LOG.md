...
**一期没法做准**：`workbench/EP032/EP032.transcript.txt` 和 `bilibili/raw/` 下的 srt 装的都是 EP024（石家庄外卖小哥）的稿子，全仓库没有备份，B 站视频也已下架。EP032 现在只按标题能担保的名词写，一个数字一个日期都没有。要做准得重新拿到那期的音频或字幕。
