...
const WEBSITE_LOG_ENTRIES = [
  {
    ...
    title: '全站延展话题多点修正',
    items: [
      'EP001 到 EP133 的节目详情页延展话题完成二次修正，从过度合并的单段主题线调整为 284 条主题点：每期保留 2-5 点，每点至少串联 2 个外部节目。',
      '延展话题小标题统一改成短句式“关于xxx”，例如“关于潘石屹”“关于匈牙利”“关于新加坡中立”，优先让读者一眼看懂涉及的人、事、行业或国家。',
      'SOP 和延展话题审查脚本同步加入 2-5 点、多链接和标题反例规则，后续严格审查会同时检查关联节目说明、小标题是否直观、以及是否仍出现孤立单节目条目。'
    ]
  },
  {
    date: '2026-05-06',
